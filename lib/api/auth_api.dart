...
class AuthApi {
  static Future<String?> signUp(String email, String password,
    ...
    String url = "${Api.host}/auth/users/";
  ...
  static Future<String?> resetPassword(String email) async {
    String url = "${Api.host}/auth/users/reset_password/";
  ...
  static Future<String?> resetPasswordfinal(
    ...
    String url = "${Api.host}/auth/users/reset_password_confirm/";
  ...
  static Future<String?> activation(String uid, String token) async {
    String url = "${Api.host}/auth/users/activation/";
    final response = await http.post(Uri.parse(url), body: {
      'uid': uid,
      'token': token,
    });
  ...
  static Future<String?> resendActivation(String email) async {
    String url = "${Api.host}/auth/users/resend_activation/";
    final response = await http.post(Uri.parse(url), body: {
      'email': email,
    });
    print(response.statusCode);
